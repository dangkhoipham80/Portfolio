 ...
 *
 * Fetches on open rather than with the page: most edits never touch the
 * gallery, and the library is the one list on this screen that grows without
 * bound.
 */
